...
public class C01_Xpath {
    public static void main(String[] args) throws InterruptedException {
        ...
        //2- Add Element butonidi duzelttiniz
        // y.xpath("//button[@onclick = 'addElement()']")).click();

        //3- Delete butonu’nun gorunur oldugunu test edin
        WebElement deleteButonElementi= driver.findElement(By.xpath("//button[@onclick = 'deleteElement()']"));//locate ettik
        ...
        if (addRemoveElementi.isDisplayed()){  // gorunur oldugunu test etmek icin isDisplay() yapiyoruz
