...
public class C02_ReadExel{
    ...
    public void test01() throws IOException {
        String dosyaYolu="src/test/java/day09_exel_screenshot_jsExecutor/ulkeler.xlsx";
        ...
        System.out.println("Sayfa2 satir sayisi : " + (workbook.getSheet("Sayfa2").getLastRowNum()+1));//son satir indexini verir
