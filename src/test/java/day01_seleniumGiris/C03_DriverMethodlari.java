...
public class C03_DriverMethodlari {
    public static void main(String[] args) {
       ...
       // System.setProperty("Webdriver.chrome.driver","drivers/chromedriver");
        ...
        System.out.println("URL : "+driver.getCurrentUrl()); // URL : https://www.amazon.com/ o anki gecerli URL i getirir getCurrentUrl()
        ...
        String actualUrl = driver.getCurrentUrl();// actual degerlerini her zaman URL den alir
